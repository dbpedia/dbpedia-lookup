...
<body>
    <div id="main-panel">
        <div id="header-panel">
            <img id="logo" src="https://wiki.dbpedia.org/sites/default/files/DBpediaLogoFull.png" height="96px" />
            <h1>Lookup</h1>
        </div>
         <div id="footer-panel">
            <div>Documentation at <a href="https://github.com/dbpedia/dbpedia-lookup">https://github.com/dbpedia/dbpedia-lookup</a></div>
            <div>Search API at <a href="https://lookup.dbpedia.org/api/search?query=Leipzig">https://lookup.dbpedia.org/api/search?query=Leipzig</a></div>
            <div>Auto-Complete API at <a href="https://lookup.dbpedia.org/api/prefix?query=Leipzig">https://lookup.dbpedia.org/api/search?query=Leipzig</a></div>
        </div>
    ...
    <script>
        ...
        function searchCallback(document, text) {
            ...
            for (var d in response.docs) {
                ...
                var div = document.createElement('div');
                div.innerHTML =  doc.label[0] + " - <a target='_blank' href='" + doc.resource + "'>" + doc.resource + "</a>";
                responsePanel.appendChild(div)
            }
        }
        function search() {
            var searchUrl = "https://lookup.dbpedia.org/api/search?format=JSON&query=" + document.getElementById("query").value;
